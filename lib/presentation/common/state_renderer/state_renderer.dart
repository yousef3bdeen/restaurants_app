...
import 'package:restaurants_app/presentation/resources/font_manager.dart';
...
class StateRenderer extends StatelessWidget {
  ...
  Widget _getStateWidget(BuildContext context) {
    switch (stateRendererType) {
      case StateRendererType.popupLoadingState:
        return _getpopUpDiallog(context, [_getAnimatedImage(JsonAssets.loading)]);
      ...
      case StateRendererType.popupSuccess:
        return _getpopUpDiallog(context, [
  ...
  Widget _getpopUpDiallog(BuildContext context, List<Widget> children) {
    return Dialog(
